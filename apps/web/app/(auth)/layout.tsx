  ...
  return (
    <section className="fixed inset-0 bg-background text-foreground overflow-y-auto">
      <style>{`
        ...
        .hline,.vline{position:absolute;background:hsl(var(--border) / 0.4);will-change:transform,opacity}
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        <header className="flex items-center justify-center px-6 py-4 border-b border-border/80">
